    ...
    <>
      <div className='flex justify-between p-20'>
        <div className='flex gap-4'>
          <p className={`hover:cursor-pointer ${showCustomBeersSection ? 'text-gray-400' : ''}`} onClick={() => setShowCustomBeersSection(false)}>All Beers</p>
          <p className={`hover:cursor-pointer ${!showCustomBeersSection ? 'text-gray-400' : ''}`} onClick={() => setShowCustomBeersSection(true)}>My Beers</p>
        </div>
        {
