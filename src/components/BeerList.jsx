...
export default function BeerList({ beer }) {
  return (
    <div className=' hover:bg-blue-50 flex p-4 shadow-md items-center gap-20 mb-4 h-200 w-[calc(50%-2rem)] lg:w-full' style={{ "height": "180px", "width": "" }}>
      <div style={{ "width": "100px" }} className="flex items-center justify-center">
        <Tooltip content={`Ingredients: ` + Object.keys(beer.ingredients).join(', ')} position="top">
